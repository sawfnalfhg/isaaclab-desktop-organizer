"""Isaac Lab Mimic environment wrapper for Franka Desktop Organizer IK Rel task."""
...
class FrankaDesktopOrganizerIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for Franka Desktop Organizer IK Rel env.

    This class implements the required Mimic API methods for the desktop organizer task
    with IK relative control.
    """
    ...
    def get_subtask_term_signals(self, env_ids: Sequence[int] | None = None) -> dict[str, torch.Tensor]:
        ...
        when the subtask has been completed and 0 otherwise. This implementation is required
        for manual subtask term signal annotation when running the dataset annotation tool.
        ...
        # final subtask is placing ketchup into basket - but final subtask signal is not needed
        return signals
