...
_default_dataset_path = os.path.join(_project_dir, "datasets", "dataset.hdf5")
...
parser.add_argument("--dataset_file", type=str, default=_default_dataset_path, help="Dataset file to be replayed.")
parser.add_argument(
    "--validate_states",
    action="store_true",
    default=False,
